...
class OperatingSystemScreen extends StatefulWidget {
  ...
  @override
  State<OperatingSystemScreen> createState() => _FlashcardScreenState();
}

class _FlashcardScreenState extends State<OperatingSystemScreen>
  ...
  final List<Map<String, String>> appDevelopmentCards = [
    {"question": "What is an OS?", "answer": "Software that manages computer hardware and software."},
    {"question": "What is a kernel?", "answer": "Core part of OS managing resources and communication."},
    {"question": "What is multitasking?", "answer": "Running multiple tasks simultaneously."},
    {"question": "What is a process?", "answer": "Instance of a program in execution."},
    {"question": "What is virtual memory?", "answer": "Memory management technique using disk as RAM."},
  ];
