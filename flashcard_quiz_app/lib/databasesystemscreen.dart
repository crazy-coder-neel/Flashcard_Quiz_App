...
class DatabaseSystemScreen extends StatefulWidget {
  const DatabaseSystemScreen({super.key});

  @override
  State<DatabaseSystemScreen> createState() => _FlashcardScreenState();
}

class _FlashcardScreenState extends State<DatabaseSystemScreen>
  ...
  final List<Map<String, String>> appDevelopmentCards = [
    {"question": "What is a database?", "answer": "Organized collection of structured data."},
    {"question": "What is SQL?", "answer": "Language used to manage databases."},
    {"question": "What is normalization?", "answer": "Process of organizing data to reduce redundancy."},
    {"question": "What is a primary key?", "answer": "Unique identifier for a database record."},
    {"question": "What is a foreign key?", "answer": "A key used to link two tables."},
  ];
