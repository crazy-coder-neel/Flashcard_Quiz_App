...
class CloudComputingScreen extends StatefulWidget {
  ...
  @override
  State<CloudComputingScreen> createState() => _FlashcardScreenState();
}

class _FlashcardScreenState extends State<CloudComputingScreen>
  ...
  final List<Map<String, String>> appDevelopmentCards = [
    {"question": "What is Cloud Computing?", "answer": "Using internet-based services for computing needs."},
    {"question": "What is IaaS?", "answer": "Infrastructure as a Service."},
    {"question": "What is SaaS?", "answer": "Software as a Service."},
    {"question": "What is AWS?", "answer": "Amazon's cloud computing platform."},
    {"question": "What is virtualization?", "answer": "Running multiple virtual systems on one physical system."},
  ];
