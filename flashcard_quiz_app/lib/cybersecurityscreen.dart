...
class CyberSecurityScreen extends StatefulWidget {
  ...
  @override
  State<CyberSecurityScreen> createState() => _FlashcardScreenState();
}

class _FlashcardScreenState extends State<CyberSecurityScreen>
  ...
  final List<Map<String, String>> appDevelopmentCards = [
    {"question": "What is phishing?", "answer": "Fraud attempt to steal personal data via fake messages."},
    {"question": "What is encryption?", "answer": "Converting data into unreadable format."},
    {"question": "What is a firewall?", "answer": "Security system that monitors and controls traffic."},
    {"question": "What is malware?", "answer": "Malicious software meant to harm systems."},
    {"question": "What is a VPN?", "answer": "Secure connection to another network over the internet."},
  ];
