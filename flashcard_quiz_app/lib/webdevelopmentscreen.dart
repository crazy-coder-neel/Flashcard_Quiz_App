...
class WebDevelopmentScreen extends StatefulWidget {
  ...
  @override
  State<WebDevelopmentScreen> createState() => _FlashcardScreenState();
}

class _FlashcardScreenState extends State<WebDevelopmentScreen>
  ...
  final List<Map<String, String>> appDevelopmentCards = [
    {"question": "What is HTML?", "answer": "Standard markup language for web pages."},
    {"question": "What is CSS?", "answer": "Used for styling HTML elements."},
    {"question": "What is JavaScript?", "answer": "Scripting language to make web pages interactive."},
    {"question": "Frontend vs Backend?", "answer": "Frontend is UI, Backend is server-side logic."},
    {"question": "What is a framework?", "answer": "Predefined structure for faster development."},
  ];
